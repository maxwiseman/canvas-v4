...
export class UsersResource {
	...
	activityStream(): CanvasPagedList<ActivityStreamItem> {
		return this.#http.getList<ActivityStreamItem>(
	...
	setCourseNickname(
		...
		return this.#http.put<CourseNickname>(
			`/users/self/course_nicknames/${courseId}`,
			{ nickname },
		);
	}

	removeCourseNickname(courseId: string | number): Promise<CourseNickname> {
		return this.#http.delete<CourseNickname>(
			`/users/self/course_nicknames/${courseId}`,
		);
	}
